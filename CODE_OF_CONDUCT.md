...
This Code of Conduct applies within all project spaces — GitHub issues, pull requests, discussions, commit messages — and also applies when an individual is officially representing the project in public spaces (e.g., social media, conferences, online communities).
...
Maintainers will follow these Community Impact Guidelines when determining the consequence for any violation:
...
**Consequence:** A temporary ban from any sort of interaction or public communication with the project community for a specified period.
