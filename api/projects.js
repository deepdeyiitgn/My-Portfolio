      ...
      await watermarkSitesCol.updateOne(
        { domain },
        {
          $set: {
            ...
            challengeTokenHash: sha256Hex(challengeToken),
            challengePath: site.challengePath || '/.well-known/deep-watermark-verification.txt',
            challengeIssuedAt: now,
            challengeExpiresAt: new Date(now.getTime() + WATERMARK_VERIFY_CHALLENGE_TTL_MS),
            hidden: false,
            verifiedAt: now,
            updatedAt: now,
