...
export default function FeatureAuthoringStandards() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Authoring Standards',
        route: '/feature/feature-authoring-standards',
        category: 'Documentation',
        summary: 'Feature Authoring Standards is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Authoring Standards documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature authoring standards, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Authoring Standards includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Authoring Standards Coverage Panel',
          ...
          {
            title: 'Feature Authoring Standards Stability Panel',
