...
export default function FeatureDiagramReadability() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Diagram Readability',
        route: '/feature/feature-diagram-readability',
        category: 'Visualization',
        summary: 'Feature Diagram Readability is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Diagram Readability documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature diagram readability, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Diagram Readability includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Diagram Readability Coverage Panel',
          ...
          {
            title: 'Feature Diagram Readability Stability Panel',
