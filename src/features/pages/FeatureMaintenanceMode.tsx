...
export default function FeatureMaintenanceMode() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Maintenance Mode',
        route: '/feature/feature-maintenance-mode',
        category: 'Operations',
        summary: 'Feature Maintenance Mode is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Maintenance Mode documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature maintenance mode, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Maintenance Mode includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Maintenance Mode Coverage Panel',
          ...
          {
            title: 'Feature Maintenance Mode Stability Panel',
