...
export default function FeatureRoutingContract() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Routing Contract',
        route: '/feature/feature-routing-contract',
        category: 'Routing',
        summary: 'Feature Routing Contract is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Routing Contract documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature routing contract, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Routing Contract includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Routing Contract Coverage Panel',
          ...
          {
            title: 'Feature Routing Contract Stability Panel',
