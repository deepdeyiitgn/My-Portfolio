...
export default function FeatureAtlasNavigation() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Atlas Navigation',
        route: '/feature/feature-atlas-navigation',
        category: 'Navigation',
        summary: 'Feature Atlas Navigation is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Atlas Navigation documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature atlas navigation, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Atlas Navigation includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Atlas Navigation Coverage Panel',
          ...
          {
            title: 'Feature Atlas Navigation Stability Panel',
