...
export default function FeatureWorkflowSequencer() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Workflow Sequencer',
        route: '/feature/feature-workflow-sequencer',
        category: 'Workflow',
        summary: 'Feature Workflow Sequencer is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Workflow Sequencer documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature workflow sequencer, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Workflow Sequencer includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Workflow Sequencer Coverage Panel',
          ...
          {
            title: 'Feature Workflow Sequencer Stability Panel',
