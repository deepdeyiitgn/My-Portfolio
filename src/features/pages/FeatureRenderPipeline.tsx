...
export default function FeatureRenderPipeline() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Render Pipeline',
        route: '/feature/feature-render-pipeline',
        category: 'Rendering Engine',
        summary: 'Feature Render Pipeline is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Render Pipeline documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature render pipeline, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Render Pipeline includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Render Pipeline Coverage Panel',
          ...
          {
            title: 'Feature Render Pipeline Stability Panel',
