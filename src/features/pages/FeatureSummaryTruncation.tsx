...
export default function FeatureSummaryTruncation() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Summary Truncation',
        route: '/feature/feature-summary-truncation',
        category: 'UX',
        summary: 'Feature Summary Truncation is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Summary Truncation documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature summary truncation, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Summary Truncation includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Summary Truncation Coverage Panel',
          ...
          {
            title: 'Feature Summary Truncation Stability Panel',
