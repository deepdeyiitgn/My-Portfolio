...
export default function FeatureVisualizationPanels() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Visualization Panels',
        route: '/feature/feature-visualization-panels',
        category: 'Visualization',
        summary: 'Feature Visualization Panels is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Visualization Panels documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature visualization panels, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Visualization Panels includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Visualization Panels Coverage Panel',
          ...
          {
            title: 'Feature Visualization Panels Stability Panel',
