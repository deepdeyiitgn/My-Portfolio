...
export default function FeatureDynamicDiscovery() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Dynamic Discovery',
        route: '/feature/feature-dynamic-discovery',
        category: 'Scalability',
        summary: 'Feature Dynamic Discovery is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Dynamic Discovery documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature dynamic discovery, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Dynamic Discovery includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Dynamic Discovery Coverage Panel',
          ...
          {
            title: 'Feature Dynamic Discovery Stability Panel',
