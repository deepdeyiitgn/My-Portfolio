...
export default function FeaturePerformanceBudget() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Performance Budget',
        route: '/feature/feature-performance-budget',
        category: 'Performance',
        summary: 'Feature Performance Budget is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Performance Budget documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature performance budget, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Performance Budget includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Performance Budget Coverage Panel',
          ...
          {
            title: 'Feature Performance Budget Stability Panel',
