...
export default function FeatureArchitectureLayers() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Architecture Layers',
        route: '/feature/feature-architecture-layers',
        category: 'Architecture',
        summary: 'Feature Architecture Layers is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Architecture Layers documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature architecture layers, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Architecture Layers includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Architecture Layers Coverage Panel',
          ...
          {
            title: 'Feature Architecture Layers Stability Panel',
