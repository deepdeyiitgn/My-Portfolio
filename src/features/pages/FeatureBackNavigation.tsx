...
export default function FeatureBackNavigation() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Back Navigation',
        route: '/feature/feature-back-navigation',
        category: 'UX',
        summary: 'Feature Back Navigation is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Back Navigation documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature back navigation, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Back Navigation includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Back Navigation Coverage Panel',
          ...
          {
            title: 'Feature Back Navigation Stability Panel',
