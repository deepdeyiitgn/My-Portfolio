...
export default function FeatureRiskRegister() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Risk Register',
        route: '/feature/feature-risk-register',
        category: 'Reliability',
        summary: 'Feature Risk Register is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Risk Register documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature risk register, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Risk Register includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Risk Register Coverage Panel',
          ...
          {
            title: 'Feature Risk Register Stability Panel',
