...
export default function FeatureReleaseReadiness() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Release Readiness',
        route: '/feature/feature-release-readiness',
        category: 'Delivery',
        summary: 'Feature Release Readiness is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Release Readiness documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature release readiness, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Release Readiness includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Release Readiness Coverage Panel',
          ...
          {
            title: 'Feature Release Readiness Stability Panel',
