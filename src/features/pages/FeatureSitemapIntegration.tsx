...
export default function FeatureSitemapIntegration() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Sitemap Integration',
        route: '/feature/feature-sitemap-integration',
        category: 'Indexing',
        summary: 'Feature Sitemap Integration is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Sitemap Integration documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature sitemap integration, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Sitemap Integration includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Sitemap Integration Coverage Panel',
          ...
          {
            title: 'Feature Sitemap Integration Stability Panel',
