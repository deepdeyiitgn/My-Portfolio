...
export default function FeatureDataOwnership() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Data Ownership',
        route: '/feature/feature-data-ownership',
        category: 'Governance',
        summary: 'Feature Data Ownership is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Data Ownership documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature data ownership, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Data Ownership includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Data Ownership Coverage Panel',
          ...
          {
            title: 'Feature Data Ownership Stability Panel',
