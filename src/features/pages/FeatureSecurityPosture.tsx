...
export default function FeatureSecurityPosture() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Security Posture',
        route: '/feature/feature-security-posture',
        category: 'Security',
        summary: 'Feature Security Posture is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Security Posture documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature security posture, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Security Posture includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Security Posture Coverage Panel',
          ...
          {
            title: 'Feature Security Posture Stability Panel',
