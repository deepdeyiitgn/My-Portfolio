...
export default function FeatureHeaderEntrypoint() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Header Entrypoint',
        route: '/feature/feature-header-entrypoint',
        category: 'Navigation',
        summary: 'Feature Header Entrypoint is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Header Entrypoint documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature header entrypoint, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Header Entrypoint includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Header Entrypoint Coverage Panel',
          ...
          {
            title: 'Feature Header Entrypoint Stability Panel',
