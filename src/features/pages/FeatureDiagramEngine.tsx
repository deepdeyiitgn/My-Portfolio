...
export default function FeatureDiagramEngine() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Diagram Engine',
        route: '/feature/feature-diagram-engine',
        category: 'Visualization',
        summary: 'Feature Diagram Engine is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Diagram Engine documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature diagram engine, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Diagram Engine includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Diagram Engine Coverage Panel',
          ...
          {
            title: 'Feature Diagram Engine Stability Panel',
