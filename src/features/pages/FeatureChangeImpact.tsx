...
export default function FeatureChangeImpact() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Change Impact',
        route: '/feature/feature-change-impact',
        category: 'Planning',
        summary: 'Feature Change Impact is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Change Impact documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature change impact, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Change Impact includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Change Impact Coverage Panel',
          ...
          {
            title: 'Feature Change Impact Stability Panel',
