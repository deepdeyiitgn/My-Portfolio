...
export default function FeatureRoadmapTracks() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Roadmap Tracks',
        route: '/feature/feature-roadmap-tracks',
        category: 'Planning',
        summary: 'Feature Roadmap Tracks is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Roadmap Tracks documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature roadmap tracks, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Roadmap Tracks includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Roadmap Tracks Coverage Panel',
          ...
          {
            title: 'Feature Roadmap Tracks Stability Panel',
