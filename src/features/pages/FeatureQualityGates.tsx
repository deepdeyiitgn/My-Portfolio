...
export default function FeatureQualityGates() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Quality Gates',
        route: '/feature/feature-quality-gates',
        category: 'Quality',
        summary: 'Feature Quality Gates is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Quality Gates documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature quality gates, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Quality Gates includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Quality Gates Coverage Panel',
          ...
          {
            title: 'Feature Quality Gates Stability Panel',
