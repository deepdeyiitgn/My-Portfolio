...
export default function FeatureSystemCore() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature System Core',
        route: '/feature/feature-system-core',
        category: 'Core Architecture',
        summary: 'Feature System Core is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature System Core documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature system core, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature System Core includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature System Core Coverage Panel',
          ...
          {
            title: 'Feature System Core Stability Panel',
