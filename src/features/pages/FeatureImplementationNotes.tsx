...
export default function FeatureImplementationNotes() {
  return (
    <FeaturePageTemplate
      content={{
        title: 'Feature Implementation Notes',
        route: '/feature/feature-implementation-notes',
        category: 'Engineering',
        summary: 'Feature Implementation Notes is a high-detail custom TSX feature page focused on architecture clarity, visual communication, and animation-led readability for complex implementation layers.',
        description: 'Feature Implementation Notes documents workflows, diagrams, implementation points, and visualization metrics so contributors can understand intent, execution sequence, and quality outcomes quickly.',
        keywords: 'feature implementation notes, deep dey feature, architecture, workflow, diagrams, visualization',
        ...
        highlights: [
          'Feature Implementation Notes includes structured point-wise communication for high-density reading.',
        ...
        visualizations: [
          {
            title: 'Feature Implementation Notes Coverage Panel',
          ...
          {
            title: 'Feature Implementation Notes Stability Panel',
